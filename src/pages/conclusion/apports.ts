...
import prosovisUrl from './prosovis.png';
import agoraUrl from './agora.png';
import fsacUrl from './fsac.png';
  ...
  content: () => html`<div>
    <div class="w-100">
      <div class="flex justify-between items-start">
        ...
        <img src="${prosovisUrl}" style="width:18%" />
      </div>
    </div>
    <div class="w-100">
      <div class="flex justify-between items-start">
        ...
        <img src="${agoraUrl}" style="width:18%" />
      </div>
    </div>
    <div class="w-100">
      <div class="flex justify-between items-start">
        ...
        <img src="${fsacUrl}" style="width:18%" />
      </div>
    </div>
  </div> `,
};
